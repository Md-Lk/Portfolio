...
> ### Highlights:
> - EF2023 Dashboard ([Web page](https://md-lk.github.io/))
...
### Current:
- Dashboards:
  - Excel (pollutant inventory)
  - IBM Cognos Analytics (sales performance)
  - MS Power BI (pollutant inventory, sales performance)
- Excel
  - General methods (VBA, dynamic arrays, LET() functions)
  - Data cleaning (survey, outlier detection)
- Py:
  - Jupyter analysis (slide deck)
  - API functional design (preview)

Data sources are included under References.md.
